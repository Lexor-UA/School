...
mixin _$Child {
 ...
 String get id; String get parentId; String get name; String get colorHex; int get level; int get xp; int get maxXp;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,parentId,name,colorHex,level,xp,maxXp);

@override
String toString() {
  return 'Child(id: $id, parentId: $parentId, name: $name, colorHex: $colorHex, level: $level, xp: $xp, maxXp: $maxXp)';
}
...
@useResult
$Res call({
 String id, String parentId, String name, String colorHex, int level, int xp, int maxXp
});
...
/// Create a copy of Child
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? parentId = null,Object? name = null,Object? colorHex = null,Object? level = null,Object? xp = null,Object? maxXp = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String parentId,  String name,  String colorHex,  int level,  int xp,  int maxXp)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Child() when $default != null:
return $default(_that.id,_that.parentId,_that.name,_that.colorHex,_that.level,_that.xp,_that.maxXp);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String parentId,  String name,  String colorHex,  int level,  int xp,  int maxXp)  $default,) {final _that = this;
switch (_that) {
case _Child():
return $default(_that.id,_that.parentId,_that.name,_that.colorHex,_that.level,_that.xp,_that.maxXp);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String parentId,  String name,  String colorHex,  int level,  int xp,  int maxXp)?  $default,) {final _that = this;
switch (_that) {
case _Child() when $default != null:
return $default(_that.id,_that.parentId,_that.name,_that.colorHex,_that.level,_that.xp,_that.maxXp);case _:
  return null;
...
class _Child implements Child {
  const _Child({required this.id, required this.parentId, required this.name, this.colorHex = '0xFF40C4FF', this.level = 1, this.xp = 0, this.maxXp = 100});
...
/// Create a copy of Child
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? parentId = null,Object? name = null,Object? colorHex = null,Object? level = null,Object? xp = null,Object? maxXp = null,}) {
  return _then(_Child(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,parentId: null == parentId ? _self.parentId : parentId // ignore: cast_nullable_to_non_nullable
as String,name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
